...
public class NatsMessengerConnection extends MessengerConnection {
    ...
    @Override
    public <T extends MessengerPacketCallback> CompletableFuture<T> sendRequestPacket(String channelName, MessengerPacketCallback packet, MessengerPacketResponse<T> packetResponse) {
